...
def calculateMove():
    """Chamges the x and z variables for a block. If the block in front of the block is less than 2 blocks higher, it will move forward; otherwise it will try to move left, then backward, then finally right. """
    global x
    global y
    global z
